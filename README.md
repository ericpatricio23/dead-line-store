...
Sistema de gerenciamento de loja para desktop desenvolvido em Java, utilizando SQLite para persistência de dados.

 Sistema desktop criado para gerenciar operações básicas de uma loja, como cadastro de produtos e controle de vendas.
...
Database → gerencia a conexão com o banco SQLite
Controller → controla a lógica do menu e fluxo da aplicação 
Service -> responsavel pela logicado sistema
